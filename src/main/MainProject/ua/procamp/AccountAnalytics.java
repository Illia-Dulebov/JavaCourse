...
public class AccountAnalytics {
     ...
     */
    public java.util.List<Account> findAccountsByBirthdayMonth(Month birthdayMonth) {
        return accounts.stream()
     ...
     */
    public Map<Boolean, java.util.List<Account>> partitionMaleAccounts() {
        return accounts.stream()
     ...
     */
    public Map<String, java.util.List<Account>> groupAccountsByEmailDomain() {
        return accounts.stream()
     ...
     */
    public java.util.List<Account> sortByFirstAndLastNames() {
        return accounts.stream()

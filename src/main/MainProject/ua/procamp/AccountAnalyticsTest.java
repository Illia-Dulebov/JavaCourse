...
public class AccountAnalyticsTest {
    ...
    public void testSeparateMaleAccounts() {
        Map<Boolean, java.util.List<Account>> expectedAccountMap = getExpectedMaleMap();
        Map<Boolean, java.util.List<Account>> maleToAccountsMap = analytics.partitionMaleAccounts();

        assertEquals(expectedAccountMap, maleToAccountsMap);
    }

    private Map<Boolean, java.util.List<Account>> getExpectedMaleMap() {
        Map<Boolean, java.util.List<Account>> expectedMap = new HashMap<>(2);
    ...
    public void testFindAccountsByBirthdayMonth() {
        java.util.List<Account> expectedList = getExpectedList();
        java.util.List<Account> aprilAccounts = analytics.findAccountsByBirthdayMonth(Month.APRIL);

        assertEquals(expectedList, aprilAccounts);
    }

    private java.util.List<Account> getExpectedList() {
        return Arrays.asList(accounts.get(0), accounts.get(2));
    }

    @Test
    public void testGroupAccountsByEmailDomain() {
        Map<String, java.util.List<Account>> expectedEmailMap = getExpectedEmailMap();
        Map<String, java.util.List<Account>> emailDomainToAccountsMap = analytics.groupAccountsByEmailDomain();

        assertEquals(expectedEmailMap, emailDomainToAccountsMap);
    }

    private Map<String, java.util.List<Account>> getExpectedEmailMap() {
        Map<String, java.util.List<Account>> expectedEmailMap = new HashMap<>();
    ...
    public void testSortByFirstAndLastNames() {
        java.util.List<Account> sortedList = analytics.sortByFirstAndLastNames();
